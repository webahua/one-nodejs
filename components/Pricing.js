...
function Pricing() {
  ...
  return (
    ...
    <div className='sm:bg-[#121444] sm:h-[550px]'>
      ...
      <Link href={"/checkouts"}  className={`${onci===false ?"hidden" :'md:hidden'}`}>
            <div className='flex mt-10 w-1/2 h-[45px] bg-[#fcd980] hover:bg-[#eec96a] mx-auto rounded-3xl items-center justify-center'><p className='flex text-[14px] font-bold'>BUY NOW</p></div>
      </Link>
      <Link href={"/checkout"}  className={`${onci2===false ?"hidden" :'md:hidden'}`}>
            <div className='flex mt-10 w-1/2 h-[45px] bg-[#fcd980] hover:bg-[#eec96a] mx-auto rounded-3xl items-center justify-center'><p className='flex text-[14px] font-bold'>BUY NOW</p></div>
      </Link>
      <Link href={"/checkoutss"}  className={`${onci3===false ?"hidden" :'md:hidden'}`}>
            <div className='flex mt-10 w-1/2 h-[45px] bg-[#fcd980] hover:bg-[#eec96a] mx-auto rounded-3xl items-center justify-center'><p className='flex text-[14px] font-bold'>BUY NOW</p></div>
      </Link>
    </div>
