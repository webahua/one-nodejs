          ...
          <div className='md:w-3/5 md:ml-[500px] md:-mt-[260px] sm:h-[400px]'>
            <div className='md:w-3/4 mx-auto'>
              <div className='text-[1.2rem]'>
                ...
                <div className='flex float-right'>
                  <p className='flex hover:text-white w-12 h-12 hover:bg-blue-600 justify-center items-center hover:rounded-3xl'>上</p>
                  <p className='flex hover:text-white w-12 h-12 bg-blue-600 hover:bg-slate-600  justify-center items-center hover:rounded-3xl rounded-3xl'>下</p>
                </div>
            </div>
          </div>
          </div>
