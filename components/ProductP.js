    ...
    <div className='w-11/12 mx-auto'>
        ...
        <div className='flex pt-8'>
            <div className='w-5/6 relative sm:flex sm:items-center justify-center'>
                <div className={`${n1 === false ? 'absolute' : 'absolute hidden'}`} >
                    <Image src={Img} alt='' />
                </div>
            ...
            <div className='w-4/5  pl-10 grid gap-3 gap-y-5 sm:gap-y-20' >
                <div onClick={N1handled}  className={`${n1 === false ? ' md:h-[200px] hover:rounded-xl bg-[#dfeaf3] pt-2 pl-6 sm:text-[12px] rounded-xl': 'md:h-[200px] hover:rounded-xl pt-2 pl-6 sm:text-[12px] hover:bg-[#dfeaf3] sm:bg-[#dfeaf3] sm:rounded-xl'}`}>
                    ...
                    <br/>
                    <span className={`${n1 === false ? 'sm:hidden text-blue-400 ' : 'sm:hidden text-black text-opacity-60'}`}>You never have to worry about being discovered. Because you dont need to install the app on the target device. Save troublesome installation steps, you can easily achieve remote monitoring. Spyx makes tracking phone an easy and convenient thing.</span>
                </div>
        ...
        <div className='md:h-[200px] md:flex md:items-center mt-3 md:pt-[60px] md:pl-[40px] md:justify-center'>
