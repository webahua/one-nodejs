  ...
  <div className='h-[1300px] sm:h-[1300px] sm:bg-[#161843]'>
    ...
    <div className='w-[330px]  ml-8 sm:hidden'>
      ...
      <div className='mt-3'>
        ...
        <h2 className='text-[23px]'>Spyx 1 Months Plan</h2>
    ...
    <form className=''>
        ...
        <div className=' sm:ml-2 mt-10 md:w-3/4 mx-auto'>
          ...
          <div className='sm:ml-2 flex divide-dashed text-[14px] mx-auto mt-5 text-black text-opacity-80 sm:text-white sm:text-opacity-80'>
            <p>1 month price:</p>
            <div  className='border-b border-black w-1/3 sm:border-white'><p className='line-through float-right text-blue-600 text-[13px]'>48.99</p></div>
            <p className='ml-2 sm:text-yellow-500 sm:font-bold'>69.99 USD</p>
          </div>
        </div>
        <div className=''>
